        ...
        <div className="profile-info__container">
            <div className="profile-info__inner">
                <div className="profile-info_user-container">
                    <div className="profile-info__image-container">
                        { isLoading ? (
                            ...
                            <img className="profile-info__image" src={profileImageSrc || profileInfo?.userImageSrc} alt="profile" />
                        ) }
                            ...
                            { profileImage ? (
                                ...
                                <>
                                    ...
                                    <label htmlFor="postfile" id="postfilelabel">
                                        <span className="profile-info__file-input_btn">
                ...
                <div className="profile-info_user-edit">
                    <Icon icon="material-symbols:edit" fontSize={"25px"} color={"#fff"}  />
                </div>
            </div>
        </div>
     );
