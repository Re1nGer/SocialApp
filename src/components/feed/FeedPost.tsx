...
export function FeedPost({ title, pub_date, description, image_url, link }: FeedPostPropType) {
  return (
    <div className='feed__post'>
      ...
      <div className='feed__post-content'>
        <div className='feed__post-title_container'>
          <div className='feed__post-title_author'>{title}</div>
          <div />
          <div className='feed__post-title_time'>{pub_date}</div>
        </div>
        <div className='feed__post-summary'>{description}</div>
