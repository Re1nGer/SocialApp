...
export const HeaderProfileMenu = ({ imgSrc }: HeaderProfileMenuType): JSX.Element => {
        ...
        <>
            ...
            <div className="profile_menu__container">
                ...
                <div className={`profile_menu__dropdown ${open ? 'profile_menu__dropdown--open' : ''}`}>
                    ...
                    <div className="profile_menu__dropdown-item" onClick={() => setIsLightTheme((prevState: boolean) => !prevState)}>
